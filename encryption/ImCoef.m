% 相关系数计算
function r = ImCoef(A,N)%输入数字图像A 其中N表示从图像A中随机抽取的相邻的像素点对的个数
...
figure(101);
plot(u1,v1,'b.','linewidth',8,'markersize',8);
axis([0 300 0 300]);
...
figure(102);
plot(u2,v2,'b.','linewidth',8,'markersize',8);
axis([0 300 0 300]);
set(gca,'XTick',0:50:300,'YTick',0:50:300,'fontsize',18,'fontname','times new roman');
set(gca,'XTickLabel',{'0','50','100','150','200','250','300'});
set(gca,'YTickLabel',{'0','50','100','150','200','250','300'});
...
figure(103);
plot(u3,v3,'b.','linewidth',8,'markersize',8);
axis([0 300 0 300]);
set(gca,'XTick',0:50:300,'YTick',0:50:300,'fontsize',18,'fontname','times new roman');
set(gca,'XTickLabel',{'0','50','100','150','200','250','300'});
set(gca,'YTickLabel',{'0','50','100','150','200','250','300'});
...
figure(104);
plot(u4,v4,'b.','linewidth',8,'markersize',8);
axis([0 300 0 300]);
set(gca,'XTick',0:50:300,'YTick',0:50:300,'fontsize',18,'fontname','times new roman');
set(gca,'XTickLabel',{'0','50','100','150','200','250','300'});
set(gca,'YTickLabel',{'0','50','100','150','200','250','300'});
